...
The plugin provides wrapper components to automatically display validation errors and warnings next to your meta fields in the editor.
...
### Using MetaField (Generic Wrapper)

For any other context (PluginDocumentSettingPanel, custom blocks, etc.), use the `MetaField` wrapper:
